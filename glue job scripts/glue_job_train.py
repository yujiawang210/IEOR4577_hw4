...
## @type: DataSource
## @args: [database = "hw4", table_name = "train_data", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "hw4", table_name = "train_data", transformation_ctx = "datasource0")
## @type: ApplyMapping
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://yujiawang/hw4/train data"}, format = "json", transformation_ctx = "datasink2"]
## @return: datasink2
## @inputs: [frame = applymapping1]
datasink2 = glueContext.write_dynamic_frame.from_options(frame = mapping1, connection_type = "s3", connection_options = {"path": "s3://yujiawang/hw4/train data"}, format = "json", transformation_ctx = "datasink2")
job.commit()